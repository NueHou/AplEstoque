...
public class MovimentoEstoqueCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //oProduto.setId_Produto(id_Produto);
         oMovimentoEstoque.setId_Produto(new Produto(id_Produto, "", ""));
        //TipoMovimento oTipoMovimento = new TipoMovimento();
        //oTipoMovimento.setIdTipoMovimento(idTipoMovimento);
        oMovimentoEstoque.setIdTipoMovimento(new TipoMovimento(idTipoMovimento, "", ""));
        //Funcionario oFuncionario = new Funcionario();
        //oFuncionario.setIdFuncionario(idFuncionario);
        oMovimentoEstoque.setIdFuncionario(new Funcionario(idFuncionario,"",""));
