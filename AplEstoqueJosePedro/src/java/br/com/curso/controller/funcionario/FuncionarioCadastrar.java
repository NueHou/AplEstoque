    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        oFuncionario.setNomeFuncionario(nomeFuncionario);
            ...
            if (dao.cadastrar(oFuncionario)){
                ...
                mensagem = "Problemas ao Cadastrar o Funcionario. Verifique os dados informados e tente novamente!";
            }
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("FuncionarioListar");
        }catch (Exception ex){
            System.out.println("Problemas no Servlet ao cadastrar o Funcionario! Erro: "+ex.getMessage());
        }
    }
