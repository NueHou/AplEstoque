            ...
            <tbody>
                <c:forEach var="movimentoestoque" items="${movimentoestoques}">
                    <tr>
                        ...
                        <td align="left">${movimentoEstoque.produto.id_Produto}</td>
                        <td align="left">${movimentoEstoque.tipoMovimento.idTipoMovimento}</td>
                        <td align="left">${movimentoEstoque.funcionario.idFuncionario}</td>
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/MovimentoEstoqueExcluir?idMovimento=${movimentoEstoque.idMovimento}">Excluir</a></td>
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/MovimentoEstoqueExcluir?idMovimento=${movimentoEstoque.idMovimento}">Alterar</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
